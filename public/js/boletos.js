// js/boletos.js - Gestión de boletos para administradores (versión simplificada)

import { db, collection, getDocs, doc, updateDoc, deleteDoc, Timestamp } from "./firebase-config.js"

document.addEventListener("DOMContentLoaded", async () => {
    console.log("Cargando página de gestión de boletos (versión simplificada)...")
